...
reg mlife_on1_0, mlife_on2_0, mlife_on3_0,mlife_on4_0,mlife_on5_0;
...
parameter PLAY_ST = 1;
parameter  MLIFE_5_ST = 0,MLIFE_4_ST = 1,MLIFE_3_ST =2 ,MLIFE_2_ST = 3,MLIFE_1_ST = 4,MDEAD_ST=5;
...
always @(*) begin
    case(monster_life_st)
        ...
        MDEAD_ST: n_monster_life_st = (c_game_st == PLAY_ST) ? MLIFE_5_ST : MDEAD_ST;
        default: n_monster_life_st = MLIFE_5_ST;
    endcase
end
...
always @(*) begin
    case(monster_life_st)
    MLIFE_5_ST: begin  
    mlife_on1_0 <= 1; mlife_on2_0 <= 1; mlife_on3_0 <= 1; mlife_on4_0 <= 1; mlife_on5_0 <= 1;
    end
    MLIFE_4_ST: begin  
    mlife_on1_0 <= 1; mlife_on2_0 <= 1; mlife_on3_0 <= 1; mlife_on4_0 <= 1; mlife_on5_0 <= 0; 
    end
    MLIFE_3_ST: begin  
    mlife_on1_0 <= 1; mlife_on2_0 <= 1; mlife_on3_0 <= 1; mlife_on4_0 <= 0; mlife_on5_0 <= 0; 
    end
    MLIFE_2_ST: begin  
    mlife_on1_0 <= 1; mlife_on2_0 <= 1; mlife_on3_0 <= 0; mlife_on4_0 <= 0; mlife_on5_0 <= 0;
    end
    MLIFE_1_ST: begin  
    mlife_on1_0 <= 1; mlife_on2_0 <= 0; mlife_on3_0 <= 0; mlife_on4_0 <= 0; mlife_on5_0 <= 0; 
    end
    MDEAD_ST: begin
    mlife_on1_0 <= 0; mlife_on2_0 <= 0; mlife_on3_0 <= 0; mlife_on4_0 <= 0; mlife_on5_0 <= 0; 
    end
    default: begin  
    mlife_on1_0 <= 1; mlife_on2_0 <= 1; mlife_on3_0 <= 1; mlife_on4_0 <= 1; mlife_on5_0 <= 1; 
end
...
assign m_char_addr = (mlife_on1)? m_char_addr_l :(mlife_on2)? m_char_addr_l:(mlife_on3) ?m_char_addr_l:(mlife_on4) ?m_char_addr_l:(mlife_on5) ?m_char_addr_l:0;
assign m_row_addr = (mlife_on1)? m_row_addr_l :  (mlife_on2)? m_row_addr_l: (mlife_on3)? m_row_addr_l :(mlife_on4)? m_row_addr_l :(mlife_on5)? m_row_addr_l: 0; 
assign m_bit_addr =  (mlife_on1)? m_bit_addr_l : (mlife_on2)? m_bit_addr_l:(mlife_on3)?m_bit_addr_l : (mlife_on4)?m_bit_addr_l :(mlife_on5)?m_bit_addr_l : 0; 

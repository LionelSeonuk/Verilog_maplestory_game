module fireball
#(
    parameter FIREBALL_INITIAL_LEFT = 450,
...
wire local_rst = (c_left < 10);

always @(*) begin
    if (frame_tick==1 && tick) begin
        n_left = local_rst ?  FIREBALL_INITIAL_LEFT: c_left - 3;
        n_top = c_top;
    end else begin
        n_left = c_left;
        n_top = c_top;
